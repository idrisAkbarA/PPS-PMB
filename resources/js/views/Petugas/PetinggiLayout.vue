  ...
  <v-app id="inspire">
    ...
    >
      <vue-scroll :ops="scrollOps">
        ...
        <v-list dense>
          <v-list-item
            :to="`/${$route.params.petugas}/dashboard`"
            router
            exact
          >
            <v-list-item-action>
          ...
          <v-list-item
            :to="`/${$route.params.petugas}/ganti-password`"
            router
            exact
          >
            <v-list-item-action>
          ...
          <v-list-item
            :to="`/${$route.params.petugas}/kelola-petugas`"
            router
            exact
          >
            <v-list-item-action>
      ...
      return [
        {
          ...
          to: `/${petugas}/pendaftar`,
        },
        {
          icon: "mdi-book-multiple",
          title: "Pendaftaran",
          to: `/${petugas}/kelola-pendaftaran`,
        },
        {
          icon: "mdi-book-plus",
          title: "Temu Ramah",
          to: `/${petugas}/kelola-temu-ramah`,
        },
      ];
    },
    CATpages() {
      ...
      return [
        {
          ...
          title: "Laporan Ujian",
          to: `/${petugas}/laporan-ujian`,
        },
        // {
        //   icon: "mdi-tools",
        //   title: "Setting Ujian",
        //   to: `/${petugas}/setting-ujian`,
        // },
        // {
        //   icon: "mdi-file-document",
        //   title: "Hasil Ujian",
        //   to: `/${petugas}/kelola-kategori`
        // }
      ];
    },
  },
